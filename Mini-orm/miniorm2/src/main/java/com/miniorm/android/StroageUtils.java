...
public final class StroageUtils {
    ...
    public static File getCacheFile(Context context, String fileName) throws IOException {
        File filedir = getOwnCacheDirectory(context, "cache");

        File fille = new File(filedir, fileName);
        if (!fille.exists()) {
            fille.createNewFile();
        }
        return  fille;
