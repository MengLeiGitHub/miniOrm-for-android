...
public class ResultParseimpl implements BaseResultParseInterface<Cursor> {
    ...
    public <T> T parse(Cursor cursor, Class<T> t, ReflexEntity reflexEntity) throws IllegalAccessException, InstantiationException {
        // TODO Auto-generated method stub
        if (cursor != null && cursor.moveToFirst()) {
            Object t1= parseObj(reflexEntity,true,t,cursor);
            if (cursor != null)
                cursor.close();
              return  (T)t1;
        }else {
    ...
    private  Object   parseObj(ReflexEntity reflexEntity,boolean isDeep,Class t,Cursor  cursor)throws IllegalAccessException, InstantiationException{
        ...
        for (String column : hashmap.keySet()) {
            ...
            if (tableColumn != null && !tableColumn.isForeignkey() || tableID != null) {
                ...
                if(isDeep){
                    ...
                    Object fieldObj=parseObj(reflexEntity1,false,fieldCls,cursor);
